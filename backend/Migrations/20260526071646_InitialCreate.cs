        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredGwa = table.Column<double>(type: "double precision", nullable: false),
                    MaxHouseholdIncome = table.Column<decimal>(type: "numeric", nullable: false),
                    EligibleCourses = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scholarships_Barangays_BarangayId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredScholarshipType = table.Column<int>(type: "integer", nullable: true),
                    BarangayId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_Barangays_BarangayId",
                        column: x => x.BarangayId,
                        principalTable: "Barangays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scholarships_BarangayId",
                table: "Scholarships",
                column: "BarangayId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_BarangayId",
                table: "Students",
                column: "BarangayId");
        }
