  ...
  return (
    <div className="modal-overlay" onClick={onClose} style={{ zIndex: 9999 }}>
      ...
      >
        ...
        <h2 className="celebration-title">Aw, Hindi Paldo! 😅</h2>

        <p className="celebration-message">
          Don't worry, hindi pa tapos ang laban! Your application for <br />
          <strong>{application.scholarshipName}</strong>
          <br /> wasn't approved this time.
        </p>

        <div className="celebration-info-box danger">
          <span className="celebration-info-text">
            There are still plenty of other opportunities in your dashboard.
            Keep applying!
          </span>
        </div>
